...
class CRC4Crypt
{
    ...
    {
        return CRC4Crypt::encrypt($pwd, $data, $ispwdHex);
    }

    /**
     * Кодирует в rc4 результат возвращает в base64
     */
    function base64_encrypt($pwd, $data, $ispwdHex = 0)
    {
        return base64_encode(CRC4Crypt::encrypt($pwd, $data, $ispwdHex));
    }

    /**
     * Декодирует из base64 rc4
     */
    function base64_decrypt($pwd, $data, $ispwdHex = 0)
    {
        return CRC4Crypt::decrypt($pwd, base64_decode($data), $ispwdHex);
    }
